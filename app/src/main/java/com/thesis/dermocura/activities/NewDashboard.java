...
public class NewDashboard extends AppCompatActivity {
    ...
    private ImageView doctorImageView, camera_button, messages_button;
    ...
    private void setObjects() {
        ...
        camera_button.setOnClickListener(v -> {
            Intent intent = new Intent(NewDashboard.this, ActivityCamera.class);
            startActivity(intent);
        });

        messages_button.setOnClickListener(v -> {
            Intent intent = new Intent(NewDashboard.this, ActivityTelemedicine.class);
            startActivity(intent);
        });
    }
