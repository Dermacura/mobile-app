...
public class ActivityTreatment extends AppCompatActivity {
    ...
    private void setOnClickListeners() {
        ...
        ibLeftArrow.setOnClickListener(v -> {
            Intent intentLeft = new Intent(this, ActivityRecommendation.class);
            startActivity(intentLeft);
            overridePendingTransition(0, 0);
        });
        ibRightArrow.setOnClickListener(v -> {
            Intent intentRight = new Intent(this, ActivityAnalyzation.class);
