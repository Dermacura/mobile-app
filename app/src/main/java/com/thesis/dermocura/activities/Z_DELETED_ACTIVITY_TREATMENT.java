...
public class Z_DELETED_ACTIVITY_TREATMENT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.z_deleted_activity_treatment);
    ...
    private void setOnClickListeners() {
        ...
        ibLeftArrow.setOnClickListener(v -> {
            Intent intentLeft = new Intent(this, Z_DELETED_ACTIVITY_RECOMMENDATION.class);
            startActivity(intentLeft);
            overridePendingTransition(0, 0);
        });
        ibRightArrow.setOnClickListener(v -> {
            Intent intentRight = new Intent(this, Z_DELETED_ACTIVITY_ANALYZATION.class);
    ...
    private void setObjects() {
        SkinDiseaseData skinDiseaseData = SkinDiseaseData.getInstance();
        tvBodyText.setText(skinDiseaseData.getSkinDiseaseTreatment());
        Glide.with(this)
