...
public class Z_DELETED_ACTIVITY_DASHBOARD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.z_deleted_activity_dashboard);
    ...
    private void setOnClickListeners() {
        cvScanHistory.setOnClickListener(v -> {
            Intent intentHistory = new Intent(Z_DELETED_ACTIVITY_DASHBOARD.this, ActivityHistory.class);
        ...
        ivAppointmentIcon.setOnClickListener(v -> {
            Intent intentHistory = new Intent(Z_DELETED_ACTIVITY_DASHBOARD.this, Z_DELETED_ACTIVITY_SET_APPOINTMENT.class);
            startActivity(intentHistory);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        });
        ...
        btnAnalyzeSkinDisease.setOnClickListener(v -> {
            Intent intentScan = new Intent(Z_DELETED_ACTIVITY_DASHBOARD.this, ActivityCamera.class);
            startActivity(intentScan);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        });

        ivGeolocationIcon.setOnClickListener(v -> {
            Intent intentHistory = new Intent(Z_DELETED_ACTIVITY_DASHBOARD.this, ActivityGeoLocation.class);
            startActivity(intentHistory);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        });
        ivMessageIcon.setOnClickListener(v -> {
            Intent intentHistory = new Intent(Z_DELETED_ACTIVITY_DASHBOARD.this, ActivityTelemedicine.class);
            startActivity(intentHistory);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        });
    }
