...
public class ActivityOldDashboard extends AppCompatActivity {
    ...
    private void setOnClickListeners() {
        cvScanHistory.setOnClickListener(v -> {
            Intent intentHistory = new Intent(ActivityOldDashboard.this, ActivityHistory.class);
        ...
        ivAppointmentIcon.setOnClickListener(v -> {
            Intent intentHistory = new Intent(ActivityOldDashboard.this, ActivitySetAppointment.class);
            startActivity(intentHistory);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        });
        ...
        btnAnalyzeSkinDisease.setOnClickListener(v -> {
            Intent intentScan = new Intent(ActivityOldDashboard.this, ActivityCamera.class);
            startActivity(intentScan);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        });

        ivGeolocationIcon.setOnClickListener(v -> {
            Intent intentHistory = new Intent(ActivityOldDashboard.this, ActivityGeoLocation.class);
            startActivity(intentHistory);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        });
        ivMessageIcon.setOnClickListener(v -> {
            Intent intentHistory = new Intent(ActivityOldDashboard.this, ActivityTelemedicine.class);
            startActivity(intentHistory);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
        });
    }
